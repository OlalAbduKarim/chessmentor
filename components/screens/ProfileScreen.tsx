...
import { Star, MessageCircle, UserPlus, ArrowRight, PlusCircle, Settings, LogOut, UserMinus, Edit } from 'lucide-react';
        ...
        <div className="w-full max-w-2xl mx-auto mt-8">
            <div className="flex justify-between items-center mb-4">
                 ...
                 <button 
                    ...
                    className="flex items-center gap-2 bg-soft-emerald text-white font-bold py-2 px-4 rounded-lg shadow-md hover:bg-opacity-90 transition"
                 >
